                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <span
                                class="info-box-number"> {{ $valueTransactionsAdded ? $valueTransactionsAdded .' €'  : 'N/A' }} </span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <span
                                class="info-box-number"> {{ $valueTransactionsDeducted != null ? $valueTransactionsDeducted .' €'  : 'N/A' }} </span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
